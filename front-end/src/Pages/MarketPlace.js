...
const MarketPlace = () => {
  return (
    <>
      ...
      {/*<div className="absolute top-[558px] ml-80 rounded-lg w-3/6 h-[0.5px] bg-gray-300"></div>
      <div className="absolute top-[562px] ml-60 rounded-lg w-4/6 h-[160px] bg-white flex">
        <div className="relative top-[05px] ml-2 rounded-lg w-1/5 h-[80px] bg-white">
          <p className="relative top-[05px] ml-4 left-[05px] text-xxs text-[17px]  text-black font-medium">
            Property Type
          </p>
