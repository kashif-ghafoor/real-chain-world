  ...
  return (
    <>
      <div className="card w-full md:w-[300px] h-[390px]">
        <div className="bg-white shadow-[0px_2px_2px_2px_rgba(71,_142,_117,_0.2)] w-full h-[380px]">
          <img
          ...
          <Link to={buttonText === "View Property" ? "/property" : ""}>
            <button className="text-xl md:text-4xl font-medium text-white text-center cursor-pointer border-none mt-8 ml-1 pl-4 bg-lightseagreen-100 rounded w-full md:w-[290px] h-[50px]">
              {buttonText}
            </button>
          </Link>
        </div>
